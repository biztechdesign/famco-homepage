...
export const VEHICLES: Vehicle[] = [
  ...
  },
  {
    ...
    description:
      "Sleeper cab, I-Shift, retarder, fleet maintained — Oman delivered",
    brand: "Volvo",
    country: "Oman",
    countryFlag: "🇴🇲",
    year: 2021,
  ...
  },
  {
    ...
    description:
      "3.5-ton class, hydrostatic drive, full inspection, Bahrain stock",
    brand: "Linde",
    country: "Bahrain",
    countryFlag: "🇧🇭",
    year: 2022,
  ...
  {
    id: "16",
    title: "MAN TGS 33.480 8×4 Mixer",
    description:
      "10 m³ concrete mixer, 8×4 drive, Euro 6, Kuwait stock — single owner",
    brand: "MAN",
    country: "Kuwait",
    countryFlag: "🇰🇼",
    year: 2021,
